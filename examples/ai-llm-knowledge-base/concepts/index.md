...
- [Retrieval-Augmented Generation](rag.md) — A technique that enhances LLM outputs by retrieving relevant documents from an external knowledge store and injecting them into the prompt.  [concept]
