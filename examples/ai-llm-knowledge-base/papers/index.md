...
- [Toolformer: Language Models Can Teach Themselves to Use Tools](toolformer.md) — Presents a self-supervised method for teaching LLMs to decide which external tools to call, when, and with what arguments.  [paper]
