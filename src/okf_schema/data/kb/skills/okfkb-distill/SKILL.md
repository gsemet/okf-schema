...
convergent knowledge to Concepts, Structures, or Principles. Author
`derived_from` with canonical bundle-relative, extensionless paths and never
edit CLI-computed `derives_to`. Finish with `just knowledge-lint` and
