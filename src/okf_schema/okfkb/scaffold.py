...
directory with 10 bundled YAML schema files, ``index.md``, and ``log.md``.
"""
...
def scaffold_kb(path: Path, force: bool = False) -> None:
    ...
    Creates the canonical KB folder layout with 9 content directories,
    10 schema YAML files including the shared base schema, ``index.md``, and
    ``log.md``.
