...
def test_load_schema_database_loads_json_schema() -> None:
...
def test_load_schema_database_loads_yaml_schema() -> None:
...
def test_load_schema_database_empty_dir(tmp_path: Path) -> None:
    """Returns empty dict for empty directory."""
    schemas = load_schema_database(tmp_path)
    assert schemas == {}


def test_load_schema_database_nonexistent_dir(tmp_path: Path) -> None:
    """Returns empty dict for non-existent directory."""
    schemas = load_schema_database(tmp_path / "missing")
    assert schemas == {}


def test_load_schema_database_skips_non_schema_files(tmp_path: Path) -> None:
...
def test_load_schema_database_skips_invalid_json(tmp_path: Path) -> None:
...
def test_load_schema_database_skips_invalid_json5(tmp_path: Path) -> None:
...
def test_load_schema_database_skips_invalid_yaml(tmp_path: Path) -> None:
...
def test_load_schema_database_skips_non_dict_yaml(tmp_path: Path) -> None:
...
def test_load_schema_database_skips_oserror(tmp_path: Path) -> None:
...
def test_load_schema_database_resolves_json_ref(tmp_path: Path) -> None:
...
def test_load_schema_database_resolves_yaml_ref(tmp_path: Path) -> None:
...
def test_load_schema_database_resolves_nested_ref(tmp_path: Path) -> None:
...
def test_load_schema_database_keeps_unresolvable_ref(tmp_path: Path) -> None:
...
def test_load_schema_database_resolves_ref_in_array_items(tmp_path: Path) -> None:
...
def test_load_schema_database_resolves_extensionless_ref(tmp_path: Path) -> None:
...
def test_load_schema_database_resolves_extensionless_ref_json5(tmp_path: Path) -> None:
...
def test_load_schema_database_resolves_extensionless_ref_yml(tmp_path: Path) -> None:
...
def test_load_schema_database_loads_schema_yml_extension(tmp_path: Path) -> None:
...
def test_validate_against_schema_valid_frontmatter() -> None:
...
def test_validate_against_schema_missing_required_field() -> None:
...
def test_validate_against_schema_validator_exception() -> None:
...
def test_has_block_lists_inline_list() -> None:
    """Inline list is not block-style."""
    fm = "tags: [a, b, c]\n"
    assert _has_block_lists(fm) is False


def test_has_block_lists_block_list() -> None:
    """Block list is detected."""
    fm = "tags:\n  - a\n  - b\n"
    assert _has_block_lists(fm) is True


def test_has_block_lists_mixed_inline_and_block() -> None:
    """Mixed: block list is detected even with inline present."""
    fm = "tags:\n  - a\n  - b\nother: [x, y]\n"
    assert _has_block_lists(fm) is True


def test_has_block_lists_no_lists() -> None:
    """No lists at all."""
    fm = "title: Test\ncount: 5\n"
    assert _has_block_lists(fm) is False


def test_has_block_lists_invalid_yaml() -> None:
...
def test_validate_concept_valid_concept_no_warnings(tmp_path: Path) -> None:
...
def test_validate_concept_e1_no_frontmatter(tmp_path: Path) -> None:
...
def test_validate_concept_e1_unparseable_yaml(tmp_path: Path) -> None:
...
def test_validate_concept_e2_missing_type(tmp_path: Path) -> None:
...
def test_validate_concept_e2_empty_type(tmp_path: Path) -> None:
    """E2: empty type field."""
    from okf_schema._internal.models import Report
...
def test_validate_concept_e4_schema_validation_failure(tmp_path: Path) -> None:
...
def test_validate_concept_e5_unflatten_list(tmp_path: Path) -> None:
...
def test_validate_concept_w1_missing_title(tmp_path: Path) -> None:
...
def test_validate_concept_w1_missing_description(tmp_path: Path) -> None:
...
def test_validate_concept_w2_broken_link(tmp_path: Path) -> None:
...
def test_validate_concept_w3_missing_timestamp(tmp_path: Path) -> None:
...
def test_validate_concept_w6_missing_schema(tmp_path: Path) -> None:
...
def test_validate_concept_no_w6_when_schemas_none(tmp_path: Path) -> None:
...
def test_validate_concept_w7_block_list(tmp_path: Path) -> None:
...
def test_validate_concept_no_w7_inline_list(tmp_path: Path) -> None:
...
def test_validate_concept_no_w7_no_lists(tmp_path: Path) -> None:
...
def test_validate_concept_no_w7_invalid_yaml(tmp_path: Path) -> None:
...
def test_validate_concept_no_w7_non_dict_yaml(tmp_path: Path) -> None:
...
def test_validate_index_root_index_with_frontmatter_ok(tmp_path: Path) -> None:
...
def test_validate_index_non_root_index_with_frontmatter_e3(tmp_path: Path) -> None:
...
def test_validate_index_non_root_index_without_frontmatter_ok(tmp_path: Path) -> None:
...
def test_validate_log_log_with_frontmatter_e3(tmp_path: Path) -> None:
...
def test_validate_log_log_without_frontmatter_ok(tmp_path: Path) -> None:
...
def test_validate_log_log_bad_date_w5(tmp_path: Path) -> None:
...
def test_validate_log_log_good_date_no_w5(tmp_path: Path) -> None:
...
def test_validate_log_log_no_date_headings_no_w5(tmp_path: Path) -> None:
...
def test_validate_log_log_valid_dates_no_w5(tmp_path: Path) -> None:
...
def test_validate_bundle_valid_valid_bundle_is_conformant() -> None:
...
def test_validate_bundle_e1_e1_no_frontmatter() -> None:
...
def test_validate_bundle_e1_e1_unparseable_yaml() -> None:
...
def test_validate_bundle_e2_e2_missing_type() -> None:
...
def test_validate_bundle_e2_e2_empty_type() -> None:
...
def test_validate_bundle_e3_e3_index_frontmatter() -> None:
...
def test_validate_bundle_e3_e3_log_frontmatter() -> None:
...
def test_validate_bundle_e4_e4_schema_fail() -> None:
...
def test_validate_bundle_e5_e5_unflatten_list() -> None:
...
def test_validate_bundle_e6_e6_log_outside_root() -> None:
...
def test_validate_bundle_w1_w1_missing_title() -> None:
...
def test_validate_bundle_w1_w1_missing_description() -> None:
...
def test_validate_bundle_w2_w2_broken_link() -> None:
...
def test_validate_bundle_w3_w3_missing_timestamp() -> None:
...
def test_validate_bundle_w4_w4_missing_index() -> None:
...
def test_validate_bundle_w5_w5_bad_date() -> None:
...
def test_validate_bundle_w6_w6_missing_schema() -> None:
...
def test_validate_bundle_w7_w7_block_list() -> None:
...
def test_validate_bundle_edge_cases_empty_bundle(tmp_path: Path) -> None:
...
def test_validate_bundle_edge_cases_bundle_not_a_directory(tmp_path: Path) -> None:
...
def test_validate_bundle_edge_cases_bundle_with_external_links(tmp_path: Path) -> None:
...
def test_validate_bundle_edge_cases_bundle_root_may_lack_index(tmp_path: Path) -> None:
...
def test_validate_bundle_edge_cases_missing_schema_db(tmp_path: Path) -> None:
