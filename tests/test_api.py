...
def test_validate_bundle_returns_report_for_valid_bundle() -> None:
...
def test_validate_bundle_returns_report_for_invalid_bundle() -> None:
...
def test_validate_bundle_with_schema_db() -> None:
...
def test_validate_markdown_files_returns_report_for_valid_files(tmp_path: Path) -> None:
...
def test_validate_markdown_files_single_input_pattern(tmp_path: Path) -> None:
...
def test_validate_markdown_files_multiple_input_patterns(tmp_path: Path) -> None:
...
def test_validate_markdown_files_glob_pattern_support(tmp_path: Path) -> None:
...
def test_validate_markdown_files_error_detection_no_frontmatter(tmp_path: Path) -> None:
...
def test_validate_markdown_files_error_detection_missing_type(tmp_path: Path) -> None:
...
def test_validate_markdown_files_no_files_found_returns_empty_report() -> None:
...
def test_validate_markdown_files_unparseable_yaml_frontmatter(tmp_path: Path) -> None:
...
def test_validate_markdown_files_missing_title_and_description_warnings(tmp_path: Path) -> None:
...
def test_validate_markdown_files_missing_timestamp_warning(tmp_path: Path) -> None:
...
def test_validate_markdown_files_block_style_lists_warning(tmp_path: Path) -> None:
...
def test_validate_markdown_files_schema_validation_error(tmp_path: Path) -> None:
...
def test_validate_markdown_files_no_schema_warning(tmp_path: Path) -> None:
...
def test_validate_markdown_files_accepts_path_objects(tmp_path: Path) -> None:
...
def test_validate_markdown_files_with_schemas_dir(tmp_path: Path) -> None:
...
def test_validate_markdown_files_nonexistent_schemas_dir_raises(tmp_path: Path) -> None:
...
def test_validate_markdown_files_schemas_dir_is_file_raises(tmp_path: Path) -> None:
...
def test_validate_markdown_files_nested_glob_patterns(tmp_path: Path) -> None:
...
def test_validate_markdown_files_pattern_with_no_matches(tmp_path: Path) -> None:
...
def test_validate_markdown_files_absolute_path_with_wildcard(tmp_path: Path) -> None:
...
def test_validate_markdown_files_absolute_directory_path(tmp_path: Path) -> None:
...
def test_format_bundle_returns_list_of_formatted_results() -> None:
...
def test_format_bundle_check_mode_no_changes(tmp_path: Path) -> None:
...
def test_format_bundle_nonexistent_path_raises() -> None:
    """Raises FileNotFoundError for nonexistent bundle path."""
    with pytest.raises(FileNotFoundError):
        format_bundle(VALID_BUNDLE / "does-not-exist")


def test_format_bundle_not_a_directory_raises() -> None:
    """Raises NotADirectoryError when path is a file."""
    with pytest.raises(NotADirectoryError):
        format_bundle(VALID_BUNDLE / "subdir" / "concept-a.md")


def test_format_bundle_diff_mode(tmp_path: Path) -> None:
...
def test_list_bundle_returns_sorted_concept_summaries() -> None:
...
def test_list_bundle_sorted_by_path() -> None:
...
def test_list_bundle_nonexistent_path_raises() -> None:
    """Raises FileNotFoundError for nonexistent bundle path."""
    with pytest.raises(FileNotFoundError):
        list_bundle(VALID_BUNDLE / "does-not-exist")


def test_list_bundle_not_a_directory_raises() -> None:
    """Raises NotADirectoryError when path is a file."""
    with pytest.raises(NotADirectoryError):
        list_bundle(VALID_BUNDLE / "subdir" / "concept-a.md")


def test_list_bundle_empty_bundle_returns_empty(tmp_path: Path) -> None:
...
def test_list_bundle_non_stale_concept_has_stale_false() -> None:
    """OKF 0.2: fresh concept has stale=False."""
    concepts = list_bundle(VALID_BUNDLE)
    assert all(not c.stale for c in concepts)


def test_list_bundle_stale_concept_has_stale_true(tmp_path: Path) -> None:
...
def test_show_bundle_returns_concept_detail() -> None:
...
def test_show_bundle_trust_tier_unverified_for_new_concept(tmp_path: Path) -> None:
...
def test_show_bundle_trust_tier_human_reviewed(tmp_path: Path) -> None:
...
def test_show_bundle_stale_concept_detected(tmp_path: Path) -> None:
...
def test_index_bundle_returns_index_updates() -> None:
...
def test_index_bundle_creates_missing_index(tmp_path: Path) -> None:
...
def test_index_bundle_preserves_root_frontmatter(tmp_path: Path) -> None:
...
def test_index_bundle_nonexistent_path_raises() -> None:
    """Raises FileNotFoundError for nonexistent bundle path."""
    with pytest.raises(FileNotFoundError):
        index_bundle(VALID_BUNDLE / "does-not-exist")


def test_index_bundle_not_a_directory_raises() -> None:
    """Raises NotADirectoryError when path is a file."""
    with pytest.raises(NotADirectoryError):
        index_bundle(VALID_BUNDLE / "subdir" / "concept-a.md")


def test_index_bundle_empty_directory_skipped(tmp_path: Path) -> None:
...
def test_index_bundle_unchanged_when_content_identical(tmp_path: Path) -> None:
...
def test_index_bundle_index_bundle_accepts_string_path() -> None:
    """Accepts str as well as Path."""
...
def test_index_bundle_preserves_existing_descriptions(tmp_path: Path) -> None:
...
def test_index_bundle_subdir_description_from_index_body(tmp_path: Path) -> None:
...
def test_index_bundle_subdir_description_oserror(tmp_path: Path) -> None:
...
def test_index_bundle_generate_index_content_empty(tmp_path: Path) -> None:
...
def test_index_bundle_parse_existing_index_no_h1() -> None:
...
def test_index_bundle_parse_existing_index_with_intro(tmp_path: Path) -> None:
...
def test_index_bundle_schema_aware_subdir_heading(tmp_path: Path) -> None:
...
def test_index_bundle_schema_aware_subdir_intro(tmp_path: Path) -> None:
...
def test_index_bundle_schema_aware_root_descriptions(tmp_path: Path) -> None:
...
def test_index_bundle_schema_aware_fallback_to_description(tmp_path: Path) -> None:
...
def test_index_bundle_mixed_types_use_generic_fallback(tmp_path: Path) -> None:
...
def test_index_bundle_no_schema_info_preserves_existing(tmp_path: Path) -> None:
...
def test_index_bundle_schema_aware_long_description_truncated(tmp_path: Path) -> None:
...
def test_index_bundle_schema_aware_subdir_long_description_full(tmp_path: Path) -> None:
...
def test_index_bundle_get_subdir_description_truncates_long_desc(tmp_path: Path) -> None:
...
def test_search_bundle_finds_by_title_substring() -> None:
...
def test_search_bundle_finds_by_tag_substring(tmp_path: Path) -> None:
...
def test_search_bundle_empty_list_for_non_matching() -> None:
    """Returns empty list when no concepts match."""
    results = search_bundle(VALID_BUNDLE, "xyznonexistent")
    assert results == []


def test_search_bundle_case_insensitive() -> None:
...
def test_search_bundle_nonexistent_path_raises() -> None:
    """Raises FileNotFoundError for nonexistent bundle path."""
    with pytest.raises(FileNotFoundError):
        search_bundle(VALID_BUNDLE / "does-not-exist", "query")


def test_search_bundle_not_a_directory_raises() -> None:
    """Raises NotADirectoryError when path is a file."""
    with pytest.raises(NotADirectoryError):
        search_bundle(VALID_BUNDLE / "subdir" / "concept-a.md", "query")


def test_search_bundle_skips_reserved_files(tmp_path: Path) -> None:
...
def test_search_bundle_skips_no_frontmatter(tmp_path: Path) -> None:
...
def test_search_bundle_skips_unparseable_frontmatter(tmp_path: Path) -> None:
...
def test_graph_bundle_returns_adjacency_dict() -> None:
    """Returns dict mapping concept paths to linked concepts."""
    graph = graph_bundle(VALID_BUNDLE)
    assert isinstance(graph, dict)


def test_graph_bundle_cross_linked_concepts(tmp_path: Path) -> None:
...
def test_graph_bundle_skips_external_links(tmp_path: Path) -> None:
...
def test_graph_bundle_nonexistent_path_raises() -> None:
    """Raises FileNotFoundError for nonexistent bundle path."""
    with pytest.raises(FileNotFoundError):
        graph_bundle(VALID_BUNDLE / "does-not-exist")


def test_graph_bundle_not_a_directory_raises() -> None:
    """Raises NotADirectoryError when path is a file."""
    with pytest.raises(NotADirectoryError):
        graph_bundle(VALID_BUNDLE / "subdir" / "concept-a.md")


def test_graph_bundle_skips_reserved_files(tmp_path: Path) -> None:
...
def test_graph_bundle_self_link_excluded(tmp_path: Path) -> None:
...
def test_graph_bundle_link_outside_bundle_excluded(tmp_path: Path) -> None:
...
def test_backlinks_bundle_returns_backlink_results(tmp_path: Path) -> None:
...
def test_backlinks_bundle_multiple_targets(tmp_path: Path) -> None:
...
def test_backlinks_bundle_no_backlinks_returns_empty(tmp_path: Path) -> None:
...
def test_backlinks_bundle_skips_external_links(tmp_path: Path) -> None:
...
def test_backlinks_bundle_skips_reserved_files(tmp_path: Path) -> None:
...
def test_backlinks_bundle_self_link_excluded(tmp_path: Path) -> None:
...
def test_backlinks_bundle_link_outside_bundle_excluded(tmp_path: Path) -> None:
...
def test_backlinks_bundle_sorted_by_target_then_source(tmp_path: Path) -> None:
...
def test_backlinks_bundle_nonexistent_path_raises() -> None:
    """Raises FileNotFoundError for nonexistent bundle path."""
    with pytest.raises(FileNotFoundError):
        backlinks_bundle(VALID_BUNDLE / "does-not-exist", ["a.md"])


def test_backlinks_bundle_not_a_directory_raises() -> None:
    """Raises NotADirectoryError when path is a file."""
    with pytest.raises(NotADirectoryError):
...
def test_stats_bundle_returns_bundle_stats() -> None:
...
def test_stats_bundle_counts_concepts_correctly(tmp_path: Path) -> None:
...
def test_stats_bundle_counts_tags(tmp_path: Path) -> None:
...
def test_stats_bundle_nonexistent_path_raises() -> None:
    """Raises FileNotFoundError for nonexistent bundle path."""
    with pytest.raises(FileNotFoundError):
        stats_bundle(VALID_BUNDLE / "does-not-exist")


def test_stats_bundle_not_a_directory_raises() -> None:
    """Raises NotADirectoryError when path is a file."""
    with pytest.raises(NotADirectoryError):
        stats_bundle(VALID_BUNDLE / "subdir" / "concept-a.md")


def test_stats_bundle_counts_files_without_frontmatter(tmp_path: Path) -> None:
...
def test_stats_bundle_counts_reserved_files(tmp_path: Path) -> None:
...
def test_stats_bundle_counts_directories(tmp_path: Path) -> None:
...
def test_stats_bundle_counts_broken_links(tmp_path: Path) -> None:
...
def test_stats_bundle_no_tags_means_empty_distribution(tmp_path: Path) -> None:
...
def test_lint_bundle_api_converts_block_lists(tmp_path: Path) -> None:
...
def test_lint_bundle_api_check_mode(tmp_path: Path) -> None:
...
def test_lint_bundle_api_no_changes_when_inline(tmp_path: Path) -> None:
...
def test_update_bundle_returns_update_result(tmp_path: Path) -> None:
...
def test_update_bundle_creates_index_and_lints(tmp_path: Path) -> None:
...
def test_update_bundle_check_mode_no_changes(tmp_path: Path) -> None:
...
def test_update_bundle_nonexistent_path_raises() -> None:
    """Raises FileNotFoundError for nonexistent bundle path."""
    from okf_schema.api import update_bundle
...
def test_update_bundle_not_a_directory_raises() -> None:
    """Raises NotADirectoryError when path is a file."""
    from okf_schema.api import update_bundle
...
def test_rewrite_superseded_links_no_superseded_docs_returns_empty(tmp_path: Path) -> None:
...
def test_rewrite_superseded_links_rewrites_link_to_superseded_doc(tmp_path: Path) -> None:
...
def test_rewrite_superseded_links_deferred_when_no_superseded_by(tmp_path: Path) -> None:
...
def test_rewrite_superseded_links_deferred_when_replacement_missing(tmp_path: Path) -> None:
...
def test_rewrite_superseded_links_check_mode_does_not_modify_files(tmp_path: Path) -> None:
...
def test_rewrite_superseded_links_rewrites_link_in_subdirectory(tmp_path: Path) -> None:
...
def test_rewrite_superseded_links_nonexistent_path_raises() -> None:
    """Raises FileNotFoundError for nonexistent bundle path."""
    from okf_schema.api import rewrite_superseded_links
...
def test_rewrite_superseded_links_not_a_directory_raises() -> None:
    """Raises NotADirectoryError when path is a file."""
    from okf_schema.api import rewrite_superseded_links
...
def test_update_bundle_superseded_update_result_includes_rewrite_fields(tmp_path: Path) -> None:
...
def test_update_bundle_superseded_update_rewrites_superseded_then_lints(tmp_path: Path) -> None:
...
def test_update_bundle_superseded_rewrite_skips_reserved_files_as_source(tmp_path: Path) -> None:
...
def test_update_bundle_superseded_rewrite_source_without_frontmatter(tmp_path: Path) -> None:
...
def test_update_bundle_superseded_rewrite_body_with_non_matching_links(tmp_path: Path) -> None:
