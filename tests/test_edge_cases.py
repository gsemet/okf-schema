...
def test_empty_bundle_empty_bundle_directory(tmp_path: Path) -> None:
...
def test_empty_bundle_bundle_with_only_reserved_files(tmp_path: Path) -> None:
...
def test_empty_bundle_no_markdown_files_at_all(tmp_path: Path) -> None:
...
def test_concept_edge_cases_concept_with_empty_type(tmp_path: Path) -> None:
...
def test_concept_edge_cases_concept_with_no_frontmatter_at_all(tmp_path: Path) -> None:
...
def test_concept_edge_cases_concept_with_very_long_title(tmp_path: Path) -> None:
...
def test_concept_edge_cases_concept_with_special_characters_in_filename(tmp_path: Path) -> None:
...
def test_concept_edge_cases_concept_with_unicode_content(tmp_path: Path) -> None:
...
def test_concept_edge_cases_concept_with_empty_frontmatter_values(tmp_path: Path) -> None:
...
def test_schema_db_edge_cases_empty_schema_db_directory(tmp_path: Path) -> None:
...
def test_schema_db_edge_cases_schema_db_with_invalid_json(tmp_path: Path) -> None:
...
def test_schema_db_edge_cases_schema_db_with_malformed_yaml(tmp_path: Path) -> None:
...
def test_link_edge_cases_external_links_only(tmp_path: Path) -> None:
...
def test_link_edge_cases_circular_links_in_graph(tmp_path: Path) -> None:
...
def test_link_edge_cases_self_link_excluded_from_graph(tmp_path: Path) -> None:
...
def test_link_edge_cases_link_to_directory_is_valid(tmp_path: Path) -> None:
...
def test_path_edge_cases_bundle_path_is_a_file(tmp_path: Path) -> None:
...
def test_path_edge_cases_nonexistent_bundle_path(tmp_path: Path) -> None:
    """Passing a nonexistent path raises FileNotFoundError."""
    with pytest.raises(FileNotFoundError):
        validate_bundle(tmp_path / "does-not-exist")


def test_path_edge_cases_concept_path_with_parent_references(tmp_path: Path) -> None:
...
def test_path_edge_cases_bundle_path_with_tilde(tmp_path: Path) -> None:
...
def test_formatter_edge_cases_format_no_frontmatter_file(tmp_path: Path) -> None:
...
def test_formatter_edge_cases_format_idempotency(tmp_path: Path) -> None:
...
def test_formatter_edge_cases_format_deeply_nested_lists(tmp_path: Path) -> None:
...
def test_formatter_edge_cases_format_preserves_comments(tmp_path: Path) -> None:
...
def test_cli_edge_cases_validate_empty_bundle_cli(tmp_path: Path) -> None:
...
def test_cli_edge_cases_list_empty_bundle_cli(tmp_path: Path) -> None:
...
def test_cli_edge_cases_stats_empty_bundle_cli(tmp_path: Path) -> None:
...
def test_cli_edge_cases_init_existing_directory_fails(tmp_path: Path) -> None:
...
def test_cli_edge_cases_new_existing_concept_fails(tmp_path: Path) -> None:
...
def test_cli_edge_cases_show_missing_concept_cli(tmp_path: Path) -> None:
...
def test_cli_edge_cases_index_empty_bundle_cli(tmp_path: Path) -> None:
...
def test_cli_edge_cases_validate_nonexistent_bundle_cli(tmp_path: Path) -> None:
...
def test_index_edge_cases_index_preserves_root_frontmatter(tmp_path: Path) -> None:
...
def test_index_edge_cases_index_skips_empty_subdirs(tmp_path: Path) -> None:
...
def test_index_edge_cases_index_with_no_concepts(tmp_path: Path) -> None:
...
def test_search_edge_cases_search_case_insensitive(tmp_path: Path) -> None:
...
def test_search_edge_cases_search_empty_query(tmp_path: Path) -> None:
...
def test_search_edge_cases_search_reserved_files_excluded(tmp_path: Path) -> None:
...
def test_stats_edge_cases_stats_with_no_types(tmp_path: Path) -> None:
...
def test_stats_edge_cases_stats_with_no_links(tmp_path: Path) -> None:
...
def test_stats_edge_cases_stats_multiple_directories(tmp_path: Path) -> None:
