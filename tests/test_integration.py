...
def test_end_to_end_workflow_format_then_validate_consistency(tmp_path: Path) -> None:
...
def test_end_to_end_workflow_index_regenerates_all_indices(tmp_path: Path) -> None:
...
def test_end_to_end_workflow_graph_with_cross_references(tmp_path: Path) -> None:
...
def test_end_to_end_workflow_search_across_multiple_fields(tmp_path: Path) -> None:
...
def test_end_to_end_workflow_stats_computes_all_metrics(tmp_path: Path) -> None:
...
def test_end_to_end_workflow_validate_with_ref_schema(tmp_path: Path) -> None:
...
def test_end_to_end_workflow_init_creates_base_schema_and_validates(tmp_path: Path) -> None:
...
def test_cli_integration_validate_cli_with_schema_db(tmp_path: Path, schema_db: Path) -> None:
    ...
    result = runner.invoke(cli, ["validate", "--path", str(bundle), "--schema-db", str(schema_db)])
    assert result.exit_code == 0
    assert "conformant" in result.output


def test_cli_integration_show_cli_output(tmp_path: Path) -> None:
...
def test_cli_integration_backlinks_cli_output(tmp_path: Path) -> None:
...
def test_cli_integration_backlinks_cli_multiple_targets(tmp_path: Path) -> None:
...
def test_cli_integration_backlinks_cli_no_backlinks(tmp_path: Path) -> None:
...
def test_cli_integration_backlinks_cli_extensionless_target(tmp_path: Path) -> None:
...
def test_cli_integration_backlinks_cli_nonexistent_bundle(tmp_path: Path) -> None:
...
def test_kb_end_to_end_workflow_kb_update_check_mode(tmp_path: Path) -> None:
